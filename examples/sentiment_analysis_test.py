...
if __name__ == '__main__':
    ...
    #未经优化数据
    sss=set()
    sentence_embedding_train = get_sentences_embedding(train_dataset, words, weight4ind, params, We, sss)
    sentence_embedding_test = get_sentences_embedding(test_dataset, words, weight4ind, params, We, sss)
    ...
    ratio=0.1
    cut_i=(int)(ratio*len(sorted_word_var))
    cut_word_var = sorted_word_var[:cut_i]
